...
namespace ImGui
{
    ...
    IMGUI_API bool          ColorEdit3(const char* label, unsigned long* col, ImGuiColorEditFlags flags = 0);
    IMGUI_API bool          ColorEdit3(const char* label, float col[3], ImGuiColorEditFlags flags = 0);
    IMGUI_API bool          ColorEdit4(const char* label, unsigned long* col, ImGuiColorEditFlags flags = 0);
    ...
    IMGUI_API bool          SelectableFunc(const char* label, bool selected = false, ImGuiSelectableFlags flags = 0, const ImVec2& size = ImVec2(0, 0), void (*func)(ImVec2, ImVec2, const char*) = 0); // "bool selected" carry the selection state (read-only). Selectable() is clicked is returns true so you can modify your selection state. size.x==0.0: use remaining width, size.x>0.0: specify width. size.y==0.0: use label height, size.y>0.0: specify height
