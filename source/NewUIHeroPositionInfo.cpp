...
void SEASON3B::CNewUIHeroPositionInfo::SetButtonInfo()
{
	...
	// m_BtniMenu (MenuTypeButton==2) desativado — menu custom abre pelo botão HUD "Menu" (ex-MasterReset)
	...
	// m_BtniMenu disabled — see CGMResetManager "Menu" button
#endif // test_main_dev
...
bool SEASON3B::CNewUIHeroPositionInfo::BtnProcess()
{
	...
	// m_BtniMenu disabled — custom menu: CGMResetManager HUD "Menu"
#endif
	return false;
}
...
void SEASON3B::CNewUIHeroPositionInfo::RenderFrame()
{
	...
	if (!gmProtect->checkold_school())
	{
		...
		// Sem botão de menu no hero position (usa HUD "Menu" embaixo)
