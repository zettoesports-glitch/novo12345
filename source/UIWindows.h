...
enum UIWINDOWSTYLE
{
	...
	UIWINDOWSTYLE_FIXED2 = UIWINDOWSTYLE_TITLEBAR | UIWINDOWSTYLE_FRAME,
};
...
{
public:
	CUILetterReadWindow() :m_iShowType(2), m_LetterHead(){}
...
{
public:
	CUILetterWriteWindow() :m_iShowType(0),
		m_bIsSend(FALSE),
		m_iLastTabIndex(-1){}
...
{
public:
	CUIQuestionWindow(int iDialogType = 0) :m_dwReturnWindowUIID(0),
