#pragma once
#ifndef _GMURUK_MOUNTAIN_FIELD_H_
#define _GMURUK_MOUNTAIN_FIELD_H_
#include "w_BaseMap.h"

BoostSmartPointer(CGMUrukMountain);

class CGMUrukMountain : public BaseMap
{
public:
	static CGMUrukMountainPtr Make();
	CGMUrukMountain();
	virtual~CGMUrukMountain();
public:
