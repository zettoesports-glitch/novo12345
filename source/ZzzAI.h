...
float MoveHumming(vec3_t Position, vec3_t Angle, vec3_t TargetPosition, float Turn, bool Fvg = true);
void  MovePosition(vec3_t Position, vec3_t Angle, vec3_t Speed, bool Fvg = true);
