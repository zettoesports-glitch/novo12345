...
{
	// Editor button disabled: players/GMs cannot open color/mesh editor in-game.
	// Mesh effects from av-code (CEffectRenderMesh / CustomItemRenderMesh) still render.
}

bool CGMRenderGroupMesh::update()
{
	// Click handler disabled (same reason as render).
	return false;
}
