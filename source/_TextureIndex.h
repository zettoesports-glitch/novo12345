...
enum
{
	...
	IMAGE_MENU_BTN_JEWEL,		// Interface\HUD\.btn\jewel.tga
	IMAGE_MENU_BTN_VIP,			// Interface\HUD\.btn\vip.tga
	IMAGE_MENU_BTN_EVENT,		// Interface\HUD\.btn\event.tga
	IMAGE_MENU_BTN_RANK,		// Interface\HUD\.btn\rank.tga
	IMAGE_MENU_BTN_LOCK,		// Interface\HUD\.btn\lock.tga  (travar itens)
	IMAGE_MENU_BTN_SENHA,		// Interface\HUD\.btn\senha.tga (trocar senha lock)
