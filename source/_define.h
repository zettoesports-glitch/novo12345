...
#define MODEL_BODY_NUM						(4*MAX_CLASS_PLAYER)
#define MODEL_BODY_NUM_OLD					24
...
#define COLUMN_INVENTORY_EXT		8
#define ROW_INVENTORY_EXT			4
#define MAX_INVENT_EXPANSION		4
#define MAX_WHAREHOUSE_EXPANSION	2
...
#define INVENTORY_MAIN_SIZE				(64)
#define INVENTORY_EXT1_SIZE				(96)
#define INVENTORY_EXT2_SIZE				(128)
#define INVENTORY_EXT3_SIZE				(160)
#define INVENTORY_EXT4_SIZE				(192)
#define MAX_MY_INVENTORY_INDEX			(204)
#define MAX_MY_SHOP_INVENTORY_INDEX		(236)
#define INVENTORY_FULL_SIZE				(236)
#define MAX_INVENTORY					(INVENTORY_EXT4_SIZE)
...
#define REQUEST_EQUIPMENT_LUCKY_SET_MIX 15
#define REQUEST_EQUIPMENT_LUCKY_ITEM_MIX 16
...
#define EQUIPMENT_ERING_R				15 //240
#define EQUIPMENT_ERING_L				16 //239
#define EQUIPMENT_WING_CORE				17
#define EQUIPMENT_FLAG_NAT				18 //242
...
#define WHISPER_SOUND_ON       0x02
#define SLIDE_HELP_ON          0x04
#define RENDER_EFFECT_ON       0x08
#define RENDER_EQUIPMENT_ON    0x10
#define RENDER_TERRAIN_ON      0x20
#define RENDER_OBJECTS_ON      0x40
...
#define RT3_WRITE_CENTER_TO_TOP		9
