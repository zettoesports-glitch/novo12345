...
{
	int SubType = 0;
	WORD Weapon1_Type = c->Weapon[0].Type;

	if (SKKey == AT_SKILL_PIERCING || SKKey == Skill_Penetration_Strengthener)
	{
		SubType = 2;
		PlayBuffer(SOUND_BOW01, o);
	}
	CurrentSkill = SKKey;
	if (SKKey == AT_SKILL_PARALYZE || SKKey == Skill_Ice_Arrow_Strengthener)
	{
	...
	else
	{
		...
		case MODEL_BOW + 9:
		case MODEL_BOW + 8:
			CreateEffect(MODEL_ARROW_STEEL, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill);
			break;
		case MODEL_BOW + 10:
			CreateEffect(MODEL_ARROW_SAW, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill);
			break;
		case MODEL_BOW + 11:
			CreateEffect(MODEL_ARROW_LASER, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill);
			break;
		case MODEL_BOW + 12:
			CreateEffect(MODEL_ARROW_THUNDER, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill);
			break;
		case MODEL_BOW + 13:
			CreateEffect(MODEL_ARROW_WING, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill);
			break;
		case MODEL_BOW + 14:
			CreateEffect(MODEL_ARROW_BOMB, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill);
			break;
		case MODEL_BOW + 16:
			CreateEffect(MODEL_ARROW_DOUBLE, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill);
			break;
		case MODEL_BOW + 18:
			CreateEffect(MODEL_ARROW_BEST_CROSSBOW, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill);
			break;
		case MODEL_BOW + 19:
			CreateEffect(MODEL_ARROW_DRILL, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill);
			break;
		case MODEL_BOW + 26:
			CreateEffect(MODEL_ARROW_DRILL, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill);
			break;
		...
		case MODEL_BOW + 5:
		case MODEL_BOW + 27:
			CreateEffect(MODEL_ARROW, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill);
			break;
		case MODEL_BOW + 2:
			CreateEffect(MODEL_ARROW_V, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill);
			break;
		case MODEL_BOW + 6:
			CreateEffect(MODEL_ARROW_NATURE, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill);
			break;
		case MODEL_BOW + 17:
		case MODEL_BOW + 29:
			CreateEffect(MODEL_ARROW_HOLY, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill);
			break;
		case MODEL_BOW + 20:
			CreateEffect(MODEL_LACEARROW, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill);
			break;
		case MODEL_BOW + 21:
			CreateEffect(MODEL_ARROW_SPARK, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill);
			break;
		case MODEL_BOW + 22:
			CreateEffect(MODEL_ARROW_RING, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill);
			break;
		case MODEL_BOW + 23:
			CreateEffect(MODEL_ARROW_DARKSTINGER, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill);
			break;
		case MODEL_BOW + 24:
			CreateEffect(MODEL_ARROW_GAMBLE, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill);
			break;
		//default:
		//	CreateEffect(MODEL_ARROW, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill);
		//	break;
...
void CreateArrows(CHARACTER* c, OBJECT* o, OBJECT* to, WORD SkillIndex, WORD Skill, WORD SKKey)
{
	if (SKKey != AT_SKILL_PIERCING
		&& SKKey != Skill_Penetration_Strengthener
		&& SKKey != AT_SKILL_PARALYZE
		&& SKKey != Skill_Ice_Arrow_Strengthener
		&& SKKey != AT_SKILL_DEEPIMPACT)
	{
		if (Skill == 1)
		{
			if (c->Weapon[0].Type == MODEL_BOW + 18
				...
				|| c->Weapon[0].Type == MODEL_BOW + 22
				|| c->Weapon[0].Type == MODEL_BOW + 23
				|| c->Weapon[0].Type == MODEL_BOW + 24
				)
			{
				o->Angle[2] += 5.f;
		...
		if (c->Weapon[0].Type == MODEL_BOW + 19)
		{
			...
			if (b)
			{
				...
				for (int i = 0; i < 15; ++i)
				{
					Vector((float)(rand() % 360), 0.f, 0.f, ang);
					if (rand() % (2))
					{
						CreateJoint(BITMAP_JOINT_SPARK, Position, Position, ang, 3);
					}
					CreateParticle(BITMAP_SPARK, Position, ang, Light, 0);
				}
			}
		}
	}
