...
void OpenImages()
{
	...
	// Look-2.5 (6): fundo do inventário da pasta HUD/Look-2.5 (só estes dois)
	if (gmProtect->LookAndFeel == 6)
	{
		LoadBitmap("Interface\\HUD\\Look-2.5\\Item_Back01.jpg", BITMAP_INVENTORY);
		LoadBitmap("Interface\\HUD\\Look-2.5\\Item_Back02.jpg", BITMAP_INVENTORY + 1);
	}
	else
	{
	...
	else if (gmProtect->IsLook2Style())
	{
		// Look-2 (2) ou Look-2.5 (6)
		char path[160];
		const char* look = gmProtect->GetLook2Folder();
		sprintf(path, "Interface\\HUD\\%s\\Item_cap.jpg", look); LoadBitmap(path, BITMAP_INVENTORY + 3);
		sprintf(path, "Interface\\HUD\\%s\\Item_upper.jpg", look); LoadBitmap(path, BITMAP_INVENTORY + 4);
		sprintf(path, "Interface\\HUD\\%s\\Item_lower.jpg", look); LoadBitmap(path, BITMAP_INVENTORY + 5);
		sprintf(path, "Interface\\HUD\\%s\\Item_weapon01.jpg", look); LoadBitmap(path, BITMAP_INVENTORY + 6);
		sprintf(path, "Interface\\HUD\\%s\\Item_gloves.jpg", look); LoadBitmap(path, BITMAP_INVENTORY + 7);
		sprintf(path, "Interface\\HUD\\%s\\Item_boots.jpg", look); LoadBitmap(path, BITMAP_INVENTORY + 8);
		sprintf(path, "Interface\\HUD\\%s\\Item_necklace.jpg", look); LoadBitmap(path, BITMAP_INVENTORY + 9);
		sprintf(path, "Interface\\HUD\\%s\\Item_ring.jpg", look); LoadBitmap(path, BITMAP_INVENTORY + 10);
		sprintf(path, "Interface\\HUD\\%s\\Item_wing.jpg", look); LoadBitmap(path, BITMAP_INVENTORY + 14);
		sprintf(path, "Interface\\HUD\\%s\\Item_fairy.jpg", look); LoadBitmap(path, BITMAP_INVENTORY + 15);
		sprintf(path, "Interface\\HUD\\%s\\Item_weapon02.jpg", look); LoadBitmap(path, BITMAP_INVENTORY + 16);
		sprintf(path, "Interface\\HUD\\%s\\btn_pshop.jpg", look); LoadBitmap(path, BITMAP_INVENTORY_BUTTON + 2);
		sprintf(path, "Interface\\HUD\\%s\\btn_pshop2.jpg", look); LoadBitmap(path, BITMAP_INVENTORY_BUTTON + 3);
		sprintf(path, "Interface\\HUD\\%s\\repair_01.jpg", look); LoadBitmap(path, BITMAP_INVENTORY_BUTTON + 4);
		sprintf(path, "Interface\\HUD\\%s\\repair_02.jpg", look); LoadBitmap(path, BITMAP_INVENTORY_BUTTON + 5);
		sprintf(path, "Interface\\HUD\\%s\\suho_button1.jpg", look); LoadBitmap(path, BITMAP_INVENTORY_BUTTON + 6);
		sprintf(path, "Interface\\HUD\\%s\\suho_button2.jpg", look); LoadBitmap(path, BITMAP_INVENTORY_BUTTON + 7);
		sprintf(path, "Interface\\HUD\\%s\\quest1.jpg", look); LoadBitmap(path, BITMAP_INVENTORY_BUTTON + 8);
		sprintf(path, "Interface\\HUD\\%s\\quest2.jpg", look); LoadBitmap(path, BITMAP_INVENTORY_BUTTON + 9);
		sprintf(path, "Interface\\HUD\\%s\\Pet1.jpg", look); LoadBitmap(path, BITMAP_INVENTORY_BUTTON + 18);
		sprintf(path, "Interface\\HUD\\%s\\Pet2.jpg", look); LoadBitmap(path, BITMAP_INVENTORY_BUTTON + 19);
		sprintf(path, "Interface\\HUD\\%s\\Money_01.jpg", look); LoadBitmap(path, BITMAP_SKILL_INTERFACE);
		sprintf(path, "Interface\\HUD\\%s\\Money_02.jpg", look); LoadBitmap(path, BITMAP_SKILL_INTERFACE + 1);
		sprintf(path, "Interface\\HUD\\%s\\expansion_button1.jpg", look); LoadBitmap(path, BITMAP_INTERFACE);
		sprintf(path, "Interface\\HUD\\%s\\expansion_button2.jpg", look); LoadBitmap(path, BITMAP_INTERFACE + 1);
		sprintf(path, "Interface\\HUD\\%s\\level_01.jpg", look); LoadBitmap(path, BITMAP_INTERFACE + 2);
		sprintf(path, "Interface\\HUD\\%s\\level_02.jpg", look); LoadBitmap(path, BITMAP_INTERFACE + 3);
		sprintf(path, "Interface\\HUD\\%s\\Level_box.jpg", look); LoadBitmap(path, BITMAP_INTERFACE + 4);
		sprintf(path, "Interface\\HUD\\%s\\buy_01.jpg", look); LoadBitmap(path, BITMAP_INTERFACE + 5);
		sprintf(path, "Interface\\HUD\\%s\\buy_02.jpg", look); LoadBitmap(path, BITMAP_INTERFACE + 6);
		sprintf(path, "Interface\\HUD\\%s\\sell_01.jpg", look); LoadBitmap(path, BITMAP_INTERFACE + 7);
		sprintf(path, "Interface\\HUD\\%s\\sell_02.jpg", look); LoadBitmap(path, BITMAP_INTERFACE + 8);
		sprintf(path, "Interface\\HUD\\%s\\Message_box.jpg", look); LoadBitmap(path, Bitmap_Message_box);
		sprintf(path, "Interface\\HUD\\%s\\Message_box1.jpg", look); LoadBitmap(path, Bitmap_Message_box1);
		sprintf(path, "Interface\\HUD\\%s\\Message_box2.jpg", look); LoadBitmap(path, Bitmap_Message_box2);
		sprintf(path, "Interface\\HUD\\%s\\Message_box3.jpg", look); LoadBitmap(path, Bitmap_Message_box3);
		sprintf(path, "Interface\\HUD\\%s\\win_button2.tga", look); LoadBitmap(path, Bitmap_win_button2);

		sprintf(path, "Interface\\HUD\\%s\\Message_box1.jpg", look); LoadBitmap(path, BITMAP_INTERFACE + 21);
		sprintf(path, "Interface\\HUD\\%s\\Message_box2.jpg", look); LoadBitmap(path, BITMAP_INTERFACE + 22);

		sprintf(path, "Interface\\HUD\\%s\\nis_back.jpg", look); LoadBitmap(path, Bitmap_Nis_back);
		sprintf(path, "Interface\\HUD\\%s\\nis_bar.jpg", look); LoadBitmap(path, Bitmap_Nis_bar);
		sprintf(path, "Interface\\HUD\\%s\\nis_btnalpha.jpg", look); LoadBitmap(path, Bitmap_Nis_btnalpha);
		sprintf(path, "Interface\\HUD\\%s\\nis_btnarrow.jpg", look); LoadBitmap(path, Bitmap_Nis_btnarrow);
		sprintf(path, "Interface\\HUD\\%s\\nis_btnchat.jpg", look); LoadBitmap(path, Bitmap_Nis_btnchat);
		sprintf(path, "Interface\\HUD\\%s\\nis_btnend.jpg", look); LoadBitmap(path, Bitmap_Nis_btnend);
		sprintf(path, "Interface\\HUD\\%s\\nis_btnmax.jpg", look); LoadBitmap(path, Bitmap_Nis_btnmax);
		sprintf(path, "Interface\\HUD\\%s\\nis_btnmin.jpg", look); LoadBitmap(path, Bitmap_Nis_btnmin);
		sprintf(path, "Interface\\HUD\\%s\\nis_btnsize.jpg", look); LoadBitmap(path, Bitmap_Nis_btnsize);
		sprintf(path, "Interface\\HUD\\%s\\nis_hframe.jpg", look); LoadBitmap(path, Bitmap_Nis_hframe);
		sprintf(path, "Interface\\HUD\\%s\\nis_rsframe.jpg", look); LoadBitmap(path, Bitmap_Nis_rsframe);
		sprintf(path, "Interface\\HUD\\%s\\nis_rsframe.tga", look); LoadBitmap(path, Bitmap_Nis_rsframe_t);
		sprintf(path, "Interface\\HUD\\%s\\nis_vframe.jpg", look); LoadBitmap(path, Bitmap_vframe);
		sprintf(path, "Interface\\HUD\\%s\\text_button1.jpg", look); LoadBitmap(path, Bitmap_text_button1);
		sprintf(path, "Interface\\HUD\\%s\\text_button2.jpg", look); LoadBitmap(path, Bitmap_text_button2);
		sprintf(path, "Interface\\HUD\\%s\\dialogue1.jpg", look); LoadBitmap(path, Bitmap_dialogue1);
		sprintf(path, "Interface\\HUD\\%s\\dialogue2.jpg", look); LoadBitmap(path, Bitmap_dialogue2);
		sprintf(path, "Interface\\HUD\\%s\\dialogue2_1.jpg", look); LoadBitmap(path, Bitmap_dialogue2_1);
	}
#else
...
void OpenBasicData(HDC hDC)
{
	...
	// Cursores: Look-2.5 (6) usa pasta HUD/Look-2.5 (arquivos .ozt no disco; LoadBitmap pede .tga e o OpenTga troca p/ .OZT)
	{
		char cpath[192];
		const char* cbase = (gmProtect->LookAndFeel == 6) ? "Interface\\HUD\\Look-2.5\\" : "Interface\\";

		sprintf(cpath, "%sCursor.tga", cbase);
		LoadBitmap(cpath, BITMAP_CURSOR, GL_LINEAR, GL_CLAMP_TO_EDGE);
		sprintf(cpath, "%sCursorPush.tga", cbase);
		LoadBitmap(cpath, BITMAP_CURSOR + 1, GL_LINEAR, GL_CLAMP_TO_EDGE);
		sprintf(cpath, "%sCursorAttack.tga", cbase);
		LoadBitmap(cpath, BITMAP_CURSOR + 2, GL_LINEAR, GL_CLAMP_TO_EDGE);
		sprintf(cpath, "%sCursorGet.tga", cbase);
		LoadBitmap(cpath, BITMAP_CURSOR + 3, GL_LINEAR, GL_CLAMP_TO_EDGE);
		sprintf(cpath, "%sCursorTalk.tga", cbase);
		LoadBitmap(cpath, BITMAP_CURSOR + 4, GL_LINEAR, GL_CLAMP_TO_EDGE);
		sprintf(cpath, "%sCursorRepair.tga", cbase);
		LoadBitmap(cpath, BITMAP_CURSOR + 5, GL_LINEAR, GL_CLAMP_TO_EDGE);
		sprintf(cpath, "%sCursorLeanAgainst.tga", cbase);
		LoadBitmap(cpath, BITMAP_CURSOR + 6, GL_LINEAR, GL_CLAMP_TO_EDGE);
		sprintf(cpath, "%sCursorSitDown.tga", cbase);
		LoadBitmap(cpath, BITMAP_CURSOR + 7, GL_LINEAR, GL_CLAMP_TO_EDGE);
		sprintf(cpath, "%sCursorDontMove.tga", cbase);
		LoadBitmap(cpath, BITMAP_CURSOR + 8, GL_LINEAR, GL_CLAMP_TO_EDGE);
	}
	//interface
	...
	if (gmProtect->LookAndFeel == 6)
		LoadBitmap("Interface\\HUD\\Look-2.5\\CursorID.tga", BITMAP_INTERFACE_EX + 29);
	else
	...
	*/
	...
	if (gmProtect->LookAndFeel == 6)
		LoadBitmap("Interface\\HUD\\Look-2.5\\CursorAttack2.tga", BITMAP_CURSOR2);
	else
