...
namespace SEASON3B
{
	...
	class CNewUIItem3DInputMsgBox : public CNewUIMessageBoxBase, public INewUI3DRenderObj
	{
		enum
		{
			INPUTBOX_TOP_BLANK = 10,
	...
	public:
		CNewUIItem3DInputMsgBox();
		virtual ~CNewUIItem3DInputMsgBox();
		...
		DWORD GetMsgBoxType();
		DWORD GetPersonalType();
		void GetInputBoxText(unicode::t_char* strText, int index = 0);
		void SetInputBoxOption(int iOption, int index = 0);
		void SetInputBoxPosition(int x, int y, int index = 0);
		void SetInputBoxSize(int width, int height, int index = 0);
	private:
		int SeparateText(const type_string& strMsg, DWORD dwColor, BYTE byFontType);
		void SetButtonInfo();
		void AddButtonBlank(int iAddLine);
	...
	class CPersonalShopProItemValueMsgBoxLayout : public TMsgBoxLayout<CNewUIItem3DInputMsgBox>
	{
	public:
		bool SetLayout();
		static CALLBACK_RESULT ReturnDown(class CNewUIMessageBoxBase* pOwner, const leaf::xstreambuf& xParam);
	...
	class CAddPointsReceiptMsgBoxLayout : public TMsgBoxLayout<CNewUITextInputMsgBox>
	{
	public:
		bool SetLayout();
		static CALLBACK_RESULT ReturnDown(class CNewUIMessageBoxBase* pOwner, const leaf::xstreambuf& xParam);
	...
	class CNewUIItem3DInputMsgBoxLayout : public TMsgBoxLayout<CNewUIItem3DInputMsgBox>
	{
	public:
		bool SetLayout();
		static CALLBACK_RESULT ReturnDown(class CNewUIMessageBoxBase* pOwner, const leaf::xstreambuf& xParam);
