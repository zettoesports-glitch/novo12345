...
#define MSGBOX_BTN_WIDTH					((gmProtect->checkold_school()? TN_MSGBOX_BTN_WIDTH: TM_MSGBOX_BTN_WIDTH))
#define MSGBOX_BTN_HEIGHT					((gmProtect->checkold_school()? TN_MSGBOX_BTN_HEIGHT: TM_MSGBOX_BTN_HEIGHT))
#define MSGBOX_BTN_BOTTOM_BLANK				((gmProtect->checkold_school()? TN_MSGBOX_BTN_BOTTOM_BLANK: TM_MSGBOX_BTN_BOTTOM_BLANK))
#define MSGBOX_BTN_EMPTY_SMALL_WIDTH		((gmProtect->checkold_school()? TN_MSGBOX_BTN_EMPTY_SMALL_WIDTH: TM_MSGBOX_BTN_EMPTY_SMALL_WIDTH))
#define MSGBOX_BTN_EMPTY_WIDTH				((gmProtect->checkold_school()? TN_MSGBOX_BTN_EMPTY_WIDTH: TM_MSGBOX_BTN_EMPTY_WIDTH))
#define MSGBOX_BTN_EMPTY_BIG_WIDTH			((gmProtect->checkold_school()? TN_MSGBOX_BTN_EMPTY_BIG_WIDTH: TM_MSGBOX_BTN_EMPTY_BIG_WIDTH))
#define MSGBOX_BTN_EMPTY_SMALL_HEIGHT		((gmProtect->checkold_school()? TN_MSGBOX_BTN_EMPTY_SMALL_HEIGHT: TM_MSGBOX_BTN_EMPTY_SMALL_HEIGHT))
#define MSGBOX_BTN_EMPTY_HEIGHT				((gmProtect->checkold_school()? TN_MSGBOX_BTN_EMPTY_HEIGHT: TM_MSGBOX_BTN_EMPTY_HEIGHT))
#endif
...
namespace SEASON3B
{
	...
	enum
	{
		...
		MSGBOX_BTN_EMPTY_SMALL_HEIGHT = 29,
		MSGBOX_BTN_EMPTY_HEIGHT = 29,
#elif MAIN_UPDATE > 303
		TM_MSGBOX_BTN_WIDTH = 54,
		TM_MSGBOX_BTN_HEIGHT = 30,
		TM_MSGBOX_BTN_BOTTOM_BLANK = 20,
		TM_MSGBOX_BTN_EMPTY_SMALL_WIDTH = 64,
		TM_MSGBOX_BTN_EMPTY_WIDTH = 108,
		TM_MSGBOX_BTN_EMPTY_BIG_WIDTH = 180,
		TM_MSGBOX_BTN_EMPTY_SMALL_HEIGHT = 29,
		TM_MSGBOX_BTN_EMPTY_HEIGHT = 29,

		TN_MSGBOX_BTN_WIDTH = 50,
		TN_MSGBOX_BTN_HEIGHT = 18,
		TN_MSGBOX_BTN_BOTTOM_BLANK = 20,
		TN_MSGBOX_BTN_EMPTY_SMALL_WIDTH = 64,
		TN_MSGBOX_BTN_EMPTY_WIDTH = 100,
		TN_MSGBOX_BTN_EMPTY_BIG_WIDTH = 180,
		TN_MSGBOX_BTN_EMPTY_SMALL_HEIGHT = 20,
		TN_MSGBOX_BTN_EMPTY_HEIGHT = 26,
#else
		MSGBOX_BTN_WIDTH = 50,
		MSGBOX_BTN_HEIGHT = 18,
		MSGBOX_BTN_BOTTOM_BLANK = 20,
		MSGBOX_BTN_EMPTY_SMALL_WIDTH = 64,
		MSGBOX_BTN_EMPTY_WIDTH = 100,
		MSGBOX_BTN_EMPTY_BIG_WIDTH = 180,
		MSGBOX_BTN_EMPTY_SMALL_HEIGHT = 20,
		MSGBOX_BTN_EMPTY_HEIGHT = 26,
#endif // #if MAIN_UPDATE > 303
	};
	...
	class CNewUIMakeRenderMessageBox : public CNewUIMessageBoxBase
	{
	public:
		bool Create(DWORD dwType, float fPriority = 3.f);
		bool Create(DWORD dwType, const type_string& strMsg, DWORD dwColor = CLRDW_WHITE, BYTE byFontType = MSGBOX_FONT_NORMAL, float fPriority = 3.f);
	...
	class CTradeCoinMsgBoxLayout : public CNewUIMessageBoxBase
	{
	public:
		CTradeCoinMsgBoxLayout();
		~CTradeCoinMsgBoxLayout();

		DWORD GetType();

		bool Create(DWORD dwType, const type_string& strMsg, DWORD dwColor = CLRDW_WHITE, BYTE byFontType = 0, float fPriority = 3.f);
		void SetAddCallbackFunc();
		void SetButtonInfo();
		void CreateInput();
		...
		static CALLBACK_RESULT Close(class CNewUIMessageBoxBase* pOwner, const leaf::xstreambuf& xParam);
		static CALLBACK_RESULT Success(class CNewUIMessageBoxBase* pOwner, const leaf::xstreambuf& xParam);
		static CALLBACK_RESULT LButtonUp(class CNewUIMessageBoxBase* pOwner, const leaf::xstreambuf& xParam);
	private:
		DWORD m_dwType;
		CUITextInputBox* m_pInputBox[4];
		CNewUIMessageBoxButton BtnOK;
		CNewUIMessageBoxButton BtnExit;
	};
	...
	class CBuffSwellOfMPUpCancelMsgBoxLayOut : public TMsgBoxLayout<CNewUICommonMessageBox>
	{
	public:
		bool SetLayout();
		static CALLBACK_RESULT OkBtnDown(class CNewUIMessageBoxBase* pOwner, const leaf::xstreambuf& xParam);
	...
	class CBuffSwellOfMPMasteryCancelMsgBoxLayOut : public TMsgBoxLayout<CNewUICommonMessageBox>
	{
	public:
		bool SetLayout();
		static CALLBACK_RESULT OkBtnDown(class CNewUIMessageBoxBase* pOwner, const leaf::xstreambuf& xParam);
	...
	class CConfirmBuyMsgBoxLayout : public TMsgBoxLayout<CNewUI3DItemCommonMsgBox>
	{
	public:
		bool SetLayout();
		static CALLBACK_RESULT OkBtnDown(class CNewUIMessageBoxBase* pOwner, const leaf::xstreambuf& xParam);
	...
	class CBuyInvExtRequestMsgBoxLayout : public TMsgBoxLayout<CNewUICommonMessageBox>
	{
	public:
		bool SetLayout();
		static CALLBACK_RESULT OkBtnDown(class CNewUIMessageBoxBase* pOwner, const leaf::xstreambuf& xParam);
...
#ifdef EFFECT_KERNEL_VERTEX
	class CNewUIMakeRenderMessageBoxLayout : public TMsgBoxLayout<CNewUIMakeRenderMessageBox>
	{
	public:
		bool SetLayout();
		static CALLBACK_RESULT CancelBtnDown(class CNewUIMessageBoxBase* pOwner, const leaf::xstreambuf& xParam);
