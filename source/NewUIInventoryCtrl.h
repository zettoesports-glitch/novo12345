...
namespace SEASON3B
{
	...
	private:
		...
		float m_afColorStateNormal[4], m_afColorStateWarning[4];
	...
	public:
		...
		int FindItemReverseKind2(short sType, int iLevel);
		...
		int FindEmptySlot(ITEM* pItem);	//. return lineal position
		...
		bool Update();
		void UpdateProcess();
		void Render(bool RendOption = true);
