...
namespace SEASON3B
{
	class CNewUIDevilSquareEnter : public CNewUIObj  
	{
	public:
		enum IMAGE_LIST
		{		
	...
	private:
		...
		{
			ENTERDS_BASE_WINDOW_WIDTH = WIN_WINDOW_SIZEX,
			ENTERDS_BASE_WINDOW_HEIGHT = WIN_WINDOW_SIZEY,
		};
	...
	public:
		CNewUIDevilSquareEnter();
		virtual ~CNewUIDevilSquareEnter();
