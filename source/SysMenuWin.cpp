...
void CSysMenuWin::Create()
{
	...
	const char* apszBtnText[SMW_BTN_MAX] = { GlobalText[381], GlobalText[382], GlobalText[385], GlobalText[388] };
	...
	SetPosition((rInput.GetScreenWidth() - m_winBack.GetWidth()) / 2, (rInput.GetScreenHeight() - m_winBack.GetHeight()) / 2);
}
