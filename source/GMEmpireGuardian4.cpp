...
CHARACTER* GMEmpireGuardian4::CreateMonster(int iType, int PosX, int PosY, int Key)
{
	...
	case 504:
	{
		...
		gmClientModels->AccessModel(MODEL_SWORDLEFT01_EMPIREGUARDIAN_BOSS_GAION_, "Data\\Monster\\", "Boss_Karane_sword_left01");
		gmClientModels->AccessModel(MODEL_SWORDLEFT02_EMPIREGUARDIAN_BOSS_GAION_, "Data\\Monster\\", "Boss_Karane_sword_left02");
		gmClientModels->AccessModel(MODEL_SWORDRIGHT01_EMPIREGUARDIAN_BOSS_GAION_, "Data\\Monster\\", "Boss_Karane_sword_right01");
		gmClientModels->AccessModel(MODEL_SWORDRIGHT02_EMPIREGUARDIAN_BOSS_GAION_, "Data\\Monster\\", "Boss_Karane_sword_right02");
		gmClientModels->AccessModel(MODEL_SWORDMAIN01_EMPIREGUARDIAN_BOSS_GAION_, "Data\\Monster\\", "Boss_Karane_sword_main01");

		gmClientModels->OpenTexture(MODEL_SWORDLEFT01_EMPIREGUARDIAN_BOSS_GAION_, "Monster\\");
		gmClientModels->OpenTexture(MODEL_SWORDLEFT02_EMPIREGUARDIAN_BOSS_GAION_, "Monster\\");
		gmClientModels->OpenTexture(MODEL_SWORDRIGHT01_EMPIREGUARDIAN_BOSS_GAION_, "Monster\\");
		gmClientModels->OpenTexture(MODEL_SWORDRIGHT02_EMPIREGUARDIAN_BOSS_GAION_, "Monster\\");
		gmClientModels->OpenTexture(MODEL_SWORDMAIN01_EMPIREGUARDIAN_BOSS_GAION_, "Monster\\");
...
bool GMEmpireGuardian4::MoveObject(OBJECT* o)
{
	...
	case 81:
	{
		o->BlendMeshTexCoordV += timefac(0.015f);
	}
	return true;
	case 36:
	{
...
bool GMEmpireGuardian4::MoveMonsterVisual(CHARACTER* c, OBJECT* o, BMD* b)
{
	...
	case MODEL_MONSTER01 + 164:
	{
		...
		{
			CreateEffectSync(MODEL_SWORDLEFT01_EMPIREGUARDIAN_BOSS_GAION_, o->Position, o->Angle, o->Light, 0, o, -1, 0, 0, 0, o->Scale);
			CreateEffectSync(MODEL_SWORDRIGHT01_EMPIREGUARDIAN_BOSS_GAION_, o->Position, o->Angle, o->Light, 0, o, -1, 0, 0, 0, o->Scale);
			CreateEffectSync(MODEL_SWORDMAIN01_EMPIREGUARDIAN_BOSS_GAION_, o->Position, o->Angle, o->Light, 0, o, -1, 0, 0, 0, o->Scale);
		...
		{
			CreateEffectSync(MODEL_SWORDLEFT02_EMPIREGUARDIAN_BOSS_GAION_, o->Position, o->Angle, o->Light, 0, o, -1, 0, 0, 0, o->Scale);
			CreateEffectSync(MODEL_SWORDRIGHT02_EMPIREGUARDIAN_BOSS_GAION_, o->Position, o->Angle, o->Light, 0, o, -1, 0, 0, 0, o->Scale);
			CreateEffectSync(MODEL_SWORDMAIN01_EMPIREGUARDIAN_BOSS_GAION_, o->Position, o->Angle, o->Light, 0, o, -1, 0, 0, 0, o->Scale);
			...
			if (o->AnimationFrame >= 0.0f && o->AnimationFrame < 0.7f)
			{
				...
				CreateEffect(MODEL_SWORDRIGHT01_EMPIREGUARDIAN_BOSS_GAION_, v3StartPos, Angle, v3PosTo, 1, o, -1, 0, 0, 0, o->Scale);
			}
		}
		break;
		case MONSTER01_ATTACK3:
		{
			if (o->AnimationFrame >= 0.0f && o->AnimationFrame < 0.5f)
			{
				...
				b->TransformPosition(o->BoneTransform[4], v3RelativePos, v3StartPos, true);
				CreateEffect(MODEL_SWORDLEFT01_EMPIREGUARDIAN_BOSS_GAION_, v3StartPos, Angle, v3PosTo, 3, o, -1, 0, 0, 0, o->Scale);

				b->TransformPosition(o->BoneTransform[8], v3RelativePos, v3StartPos, true);
				CreateEffect(MODEL_SWORDRIGHT01_EMPIREGUARDIAN_BOSS_GAION_, v3StartPos, Angle, v3PosTo, 3, o, -1, 0, 0, 0, o->Scale);

				b->TransformPosition(o->BoneTransform[2], v3RelativePos, v3StartPos, true);
				CreateEffect(MODEL_SWORDLEFT02_EMPIREGUARDIAN_BOSS_GAION_, v3StartPos, Angle, v3PosTo, 3, o, -1, 0, 0, 0, o->Scale);

				b->TransformPosition(o->BoneTransform[10], v3RelativePos, v3StartPos, true);
				CreateEffect(MODEL_SWORDRIGHT02_EMPIREGUARDIAN_BOSS_GAION_, v3StartPos, Angle, v3PosTo, 3, o, -1, 0, 0, 0, o->Scale);

				b->TransformPosition(o->BoneTransform[6], v3RelativePos, v3StartPos, true);
				CreateEffect(MODEL_SWORDMAIN01_EMPIREGUARDIAN_BOSS_GAION_, v3StartPos, Angle, v3PosTo, 3, o, -1, 0, 0, 0, o->Scale);
			}
		}
		break;
	...
	case MODEL_MONSTER01 + 165:
	{
		...
		case MONSTER01_ATTACK1:
		{
			if (o->AnimationFrame > 7.5f && o->AnimationFrame < 10.8f)
			{
				vec3_t  Light;
		...
		case MONSTER01_ATTACK2:
		{
			...
			if (8.0f <= o->AnimationFrame && o->AnimationFrame < 10.1f)
			{
				...
				for (int i = 0; i < 100; i++)
				{
					...
					CreateParticleSync(BITMAP_FIRE, vPosition, o->Angle, o->Light, 0);
		...
		case MONSTER01_ATTACK3:
		{
			...
			{
				CHARACTER* chT = gmCharacters->GetCharacter(c->TargetCharacter);
...
{
	if (gMapManager->IsEmpireGuardian4() == false)// || checkNormalizer == false)
		return false;
	...
	case 20:
	{
		if (o->AnimationFrame > 5.4f && o->AnimationFrame < 6.5f)
		{
			...
			for (int i = 0; i < 4; ++i)
			{
				...
				CreateJointSync(BITMAP_JOINT_SPARK, o->Position, o->Position, Angle, 5, o);
			}
			CreateParticleSync(BITMAP_SPARK, o->Position, Angle, o->Light, 11);
		}
	...
	case 50:
	{
		...
		for (int i = 2; i <= 7; i++)
		{
			...
			CreateParticleSync(BITMAP_FIRE_HIK3_MONO, vPos, vAngle, vLight1, 4, o->Scale * 0.6f);
			CreateParticleSync(BITMAP_FIRE_HIK3_MONO, vPos, vAngle, vLight2, 4, o->Scale * 0.3f);
		}
	}
	return true;
	...
	case 64:
	{
			...
			(o->AnimationFrame > 23.5f && o->AnimationFrame < 25.5f))
		{
			...
			VectorAdd(o->Position, vPosition, Position);

			Vector(0.04f, 0.03f, 0.02f, Light);
			for (int i = 0; i < 3; ++i)
			{
				CreateParticleSync(BITMAP_CLOUD, Position, o->Angle, Light, 22, o->Scale, o);
			}
		}
	}
	return true;
	...
	case 82:
	{
		CreateParticleSync(BITMAP_WATERFALL_5, o->Position, o->Angle, Light, 9, o->Scale);
	}
	return true;
	case 83:
	{
		Vector(1.f, 1.f, 1.f, Light);
		CreateParticleSync(BITMAP_WATERFALL_3, o->Position, o->Angle, Light, 14, o->Scale);
	}
	return true;
	case 84:
	{
		...
		if (rand() % 8 == 0)
		{
			CreateParticleSync(BITMAP_WATERFALL_2, o->Position, o->Angle, Light, 4, o->Scale);
		}
	}
	return true;
	case 85:
	...
	case 86:
	{
		if (rand() % 6 == 0)
		{
			...
			CreateParticleSync(BITMAP_CLOUD, o->Position, o->Angle, Light, 21, o->Scale, o);
		}
	}
	return true;
	...
	case 131:
	{
		...
		{
			Vector(1.f, 1.f, 1.f, Light);
			CreateParticleSync(BITMAP_SMOKE, o->Position, o->Angle, Light, 22, o->Scale);

			Vector(1.f, 1.f, 1.f, Light);
			CreateParticleSync(BITMAP_SMOKE, o->Position, o->Angle, Light, 21, o->Scale * 2.0f, o);
		}
	}
	return true;
	...
	case 157:
	{
		if (gMapManager->currentMap == WD_73NEW_LOGIN_SCENE || gMapManager->currentMap == WD_74NEW_CHARACTER_SCENE)
			return true;
...

		{
			for (int i = 0; i < 3; ++i)
			{
				...
				for (int j = 0; j < 5; ++j)
				{
					CreateParticleSync(BITMAP_FIRE_HIK3_MONO, vPos, vAngle, vLightFire01, 3, o->Scale * 0.2f);
					CreateParticleSync(BITMAP_FIRE_HIK3_MONO, vPos, vAngle, vLightFire02, 3, o->Scale * 0.1f);
				}
...

		{
			for (int i = 0; i < 3; i++)
			{
				...
				for (int j = 0; j < 4; ++j)
				{
					CreateParticleSync(BITMAP_SMOKE, vPos, o->Angle, vLightSmoke, 65, o->Scale * 0.1, o);
				}
			}
		}
	}
	...
	case 158:
	{
		...
		{
			CreateParticleSync(BITMAP_SMOKE, o->Position, o->Angle, Light, 64, o->Scale, o);
		}
	}
	return true;
	}
...
bool GMEmpireGuardian4::RenderMonsterVisual(CHARACTER* c, OBJECT* o, BMD* b)
{
	...
	case MODEL_MONSTER01 + 164:
	{
		...
		CreateParticleSync(BITMAP_SPARK + 1, vPos, o->Angle, vLight, 10, 2.0f);
		...
		if (g_isNotCharacterBuff(o) == true && g_isCharacterBuff(o, eBuff_Berserker) == true)
		{
			...
			for (int i = 0; i < iBoneCount; ++i)
			{
				...
				if (i % 5 == 0)
				{
					...
					CreateParticleSync(BITMAP_SMOKE, vPosRage, o->Angle, vLightRage, 50, 1.0f);
					CreateParticleSync(BITMAP_SMOKELINE1 + rand() % 3, vPosRage, o->Angle, vLightRage, 0, 1.0f);
				}
			}
		}
	}
