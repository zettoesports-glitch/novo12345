...
public:
	...
	void InsertServerGroup(int iConnectIndex, int iServerPercent, char* iServerName);
	void Release();
...
protected:
	...
	void InsertServer(CServerGroup* pServerGroup, int iConnectIndex, int iServerPercent, char* iServerName);
public:
