...
static char     TokenString[MAX_PATH];
...
{
	(*GetToken)();
	return ((int)TokenNumber != 0);
}

inline float GetAsNumber()
{
	(*GetToken)();
	return TokenNumber;
}

inline char* GetAsString()
{
	(*GetToken)();
	return TokenString;
}