...
#if MAIN_UPDATE > 603
	pNewUIButton->ChangeButtonImgState(true, BITMAP_msgbox_btn_empty_very_small, true, false, false, 0.0, 0.0, 304.0, 96.0);
#else
...
bool CNewUIUnitedMarketPlaceWindow::Render()
{
	...
	if( gMapManager->currentMap == WD_79UNITEDMARKETPLACE )
	{
		g_pRenderText->SetFont(g_hFont);
		g_pRenderText->RenderText(ptOrigin.x, ptOrigin.y+10, GlobalText[3010], INVENTORY_WIDTH, 0, RT3_SORT_CENTER);
		g_pRenderText->RenderText(ptOrigin.x, ptOrigin.y+30, GlobalText[3011], INVENTORY_WIDTH, 0, RT3_SORT_CENTER);
		g_pRenderText->RenderText(ptOrigin.x, ptOrigin.y+50, GlobalText[3012], INVENTORY_WIDTH, 0, RT3_SORT_CENTER);
		
		g_pRenderText->RenderText(ptOrigin.x, ptOrigin.y+130, GlobalText[3013], INVENTORY_WIDTH, 0, RT3_SORT_CENTER);
	}
	else
	{
		g_pRenderText->SetFont(g_hFont);
		g_pRenderText->RenderText(ptOrigin.x, ptOrigin.y+10, GlobalText[3003], INVENTORY_WIDTH, 0, RT3_SORT_CENTER);
		g_pRenderText->RenderText(ptOrigin.x, ptOrigin.y+30, GlobalText[3004], INVENTORY_WIDTH, 0, RT3_SORT_CENTER);
		g_pRenderText->RenderText(ptOrigin.x, ptOrigin.y+50, GlobalText[3005], INVENTORY_WIDTH, 0, RT3_SORT_CENTER);
		g_pRenderText->RenderText(ptOrigin.x, ptOrigin.y+70, GlobalText[3006], INVENTORY_WIDTH, 0, RT3_SORT_CENTER);
		g_pRenderText->RenderText(ptOrigin.x, ptOrigin.y+90, GlobalText[3007], INVENTORY_WIDTH, 0, RT3_SORT_CENTER);
		g_pRenderText->RenderText(ptOrigin.x, ptOrigin.y+110, GlobalText[3008], INVENTORY_WIDTH, 0, RT3_SORT_CENTER);
		g_pRenderText->RenderText(ptOrigin.x, ptOrigin.y+130, GlobalText[3009], INVENTORY_WIDTH, 0, RT3_SORT_CENTER);
	}
...
void CNewUIUnitedMarketPlaceWindow::OpenningProcess()
{
