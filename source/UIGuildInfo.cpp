...
void RenderAppoint()
{
	...
	SEASON3B::RenderGoldRect(s_ptAppointWindow.x + 20, s_ptAppointWindow.y + 19, 170, 20.f, (s_eAppointType == APPOINT_SUBGUILDMASTER ? 1 : 0));
	g_pRenderText->SetBgColor(0);
	g_pRenderText->RenderText(s_ptAppointWindow.x + 20, s_ptAppointWindow.y + 24, GlobalText[1311], 170, 0, RT3_SORT_CENTER);

	SEASON3B::RenderGoldRect(s_ptAppointWindow.x + 20, s_ptAppointWindow.y + 19 + 25 - 5, 170, 20.f, (s_eAppointType == APPOINT_BATTLEMASTSER ? 1 : 0));
...
CUIGuildInfo::CUIGuildInfo()
{
	...
	m_nCurrentTab = 1;
	SetPosition(gwinhandle->GetScreenX() - 190, 0);
	SetSize(190, 380);
...
void CUIGuildInfo::RenderGuildInfoTab()
{
	...
	SEASON3B::RenderGoldRect(ptOrigin.x, ptOrigin.y, 53, 53);
	...
	SEASON3B::RenderGoldRect(ptOrigin.x, ptOrigin.y, 140, 62);
	ptOrigin.x += 5;
	ptOrigin.y += 8;
	...
	SEASON3B::RenderGoldRect(ptOrigin.x, ptOrigin.y - 14, 140, 95);
