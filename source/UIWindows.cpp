...
void CUIPhotoViewer::SetEquipmentPacket(DWORD* Equipment)
{
	...
	if (m_PhotoChar.Object.Type != MODEL_PLAYER)
		m_PhotoChar.Object.Type = MODEL_PLAYER;

	ChangeCharacterExt(0, Equipment, &m_PhotoChar, &m_PhotoHelper);

	// Evita divisao por zero / scale invalido
	float heroScale = (Hero && Hero->Object.Scale > 0.01f) ? Hero->Object.Scale : 0.7f;
	float helpScale = (m_PhotoHelper.Scale > 0.01f) ? m_PhotoHelper.Scale : 0.7f;
	m_fPhotoHelperScale = helpScale * 0.7f / heroScale;
