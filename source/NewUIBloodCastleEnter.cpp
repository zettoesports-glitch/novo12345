...
void SEASON3B::CNewUIEnterBloodCastle::CreateEntrace()
{
	m_iBloodCastleLimitLevel[0][0] = 15;
	m_iBloodCastleLimitLevel[0][1] = CharacterMachine->ConvertLevel(81) - 1;

	m_iBloodCastleLimitLevel[1][0] = CharacterMachine->ConvertLevel(81);
	m_iBloodCastleLimitLevel[1][1] = CharacterMachine->ConvertLevel(131) - 1;

	m_iBloodCastleLimitLevel[2][0] = CharacterMachine->ConvertLevel(131);
	m_iBloodCastleLimitLevel[2][1] = CharacterMachine->ConvertLevel(181) - 1;

	m_iBloodCastleLimitLevel[3][0] = CharacterMachine->ConvertLevel(181);
	m_iBloodCastleLimitLevel[3][1] = CharacterMachine->ConvertLevel(231) - 1;

	m_iBloodCastleLimitLevel[4][0] = CharacterMachine->ConvertLevel(231);
	m_iBloodCastleLimitLevel[4][1] = CharacterMachine->ConvertLevel(281) - 1;

	m_iBloodCastleLimitLevel[5][0] = CharacterMachine->ConvertLevel(281);
	m_iBloodCastleLimitLevel[5][1] = CharacterMachine->ConvertLevel(331) - 1;

	m_iBloodCastleLimitLevel[6][0] = CharacterMachine->ConvertLevel(331);
	m_iBloodCastleLimitLevel[6][1] = CharacterAttribute->MaxCharacterLevel;


	m_iBloodCastleLimitLevel[8][0] = 10;
	m_iBloodCastleLimitLevel[8][1] = CharacterMachine->ConvertLevel(61) - 1;

	m_iBloodCastleLimitLevel[9][0] = CharacterMachine->ConvertLevel(61);
	m_iBloodCastleLimitLevel[9][1] = CharacterMachine->ConvertLevel(111) - 1;

	m_iBloodCastleLimitLevel[10][0] = CharacterMachine->ConvertLevel(111);
	m_iBloodCastleLimitLevel[10][1] = CharacterMachine->ConvertLevel(161) - 1;

	m_iBloodCastleLimitLevel[11][0] = CharacterMachine->ConvertLevel(161);
	m_iBloodCastleLimitLevel[11][1] = CharacterMachine->ConvertLevel(211) - 1;

	m_iBloodCastleLimitLevel[12][0] = CharacterMachine->ConvertLevel(211);
	m_iBloodCastleLimitLevel[12][1] = CharacterMachine->ConvertLevel(261) - 1;

	m_iBloodCastleLimitLevel[13][0] = CharacterMachine->ConvertLevel(261);
	m_iBloodCastleLimitLevel[13][1] = CharacterMachine->ConvertLevel(311) - 1;

	m_iBloodCastleLimitLevel[14][0] = CharacterMachine->ConvertLevel(311);
	m_iBloodCastleLimitLevel[14][1] = CharacterAttribute->MaxCharacterLevel;
}
...
void SEASON3B::CNewUIEnterBloodCastle::RenderFrame()
{
