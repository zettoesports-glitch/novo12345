...
{
	// Character select balloon: name / guild / class+level only.
	// Reset and MasterReset are NOT shown above the head (fixed size 54).
...
void CCharInfoBalloon::Render()
{
	...
	// Reset / MasterReset above character on select screen: disabled
...
void CCharInfoBalloon::SetInfo()
{
	...
	// Do not fill reset/master strings — not displayed on character select
	m_szRese[0] = 0;
	m_szMaster[0] = 0;
