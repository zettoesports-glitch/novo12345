...
{
	gmClientModels->AccessModel(MODEL_HELPER + 10, "Data\\Item\\", "Ring", 1);
	gmClientModels->AccessModel(MODEL_HELPER + 39, "Data\\Item\\", "Ring", 1);
	gmClientModels->AccessModel(MODEL_HELPER + 40, "Data\\Item\\", "Ring", 1);
	gmClientModels->AccessModel(MODEL_HELPER + 41, "Data\\Item\\", "Ring", 1);
	gmClientModels->AccessModel(MODEL_HELPER + 42, "Data\\Item\\", "Ring", 1);
	gmClientModels->AccessModel(MODEL_HELPER + 68, "Data\\Item\\", "xmasring");
	gmClientModels->AccessModel(MODEL_HELPER + 76, "Data\\Item\\", "PandaPetRing");
	gmClientModels->AccessModel(MODEL_HELPER + 122, "Data\\Item\\", "SkeletonRing");
}

void CChangeRingManager::LoadItemTexture()
{
	gmClientModels->OpenTexture(MODEL_HELPER + 39, "Item\\Texture\\");
	gmClientModels->OpenTexture(MODEL_HELPER + 41, "Item\\Texture\\");
	gmClientModels->OpenTexture(MODEL_HELPER + 40, "Item\\Texture\\");
	gmClientModels->OpenTexture(MODEL_HELPER + 42, "Item\\Texture\\");
	gmClientModels->OpenTexture(MODEL_HELPER + 68, "Item\\Texture\\");
	gmClientModels->OpenTexture(MODEL_HELPER + 76, "Item\\Texture\\");
	gmClientModels->OpenTexture(MODEL_HELPER + 122, "Item\\Texture\\");
}
