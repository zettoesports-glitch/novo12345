...
bool CGMDoppelGanger4::MoveObject(OBJECT* o)
{
	...
	case 97:
		...
		if(o->Timer > 10.f)
			o->Timer = 0.f;
		if(o->Timer > 5.f)
     		CreateParticleSync(BITMAP_BUBBLE,o->Position,o->Angle,o->Light, 5);
		return true;
	case 102:
...
bool CGMDoppelGanger4::RenderObjectVisual( OBJECT* o, BMD* b )
{
	...
	case 96:
		...
		b->RenderMesh(0, RENDER_TEXTURE, 1.0f, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU, -(int)WorldTime%20000 * 0.00005f);
...
{
	if(gMapManager->currentMap == WD_68DOPPLEGANGER4)
	{
		return true;
	}
