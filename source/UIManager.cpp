...
POINT CUIManager::RenderWindowBase(int nHeight, int nOriginX, int nOriginY)
{
	int nWidth = 213;
	...
	RenderBitmap(BITMAP_INTERFACE + 22, fPosX, fPosY, nWidth, 5, 0.f, 0.f, nWidth / 256.f, 5.f / 8.f);
#else
	RenderBitmap(Bitmap_Message_box2, fPosX, fPosY, nWidth, 5, 0.f, 0.f, nWidth / 256.f, 5.f / 8.f);
	fPosY += 5;
	...
	for (int i = 0; i < nPatternCount; ++i)
	{
		RenderBitmap(Bitmap_Message_box1, fPosX, fPosY, nWidth, 40, 0.f, 0.f, nWidth / 256.f, 40.f / 64.f);
		fPosY += 40;
	}
	if (nBodyHeight > nPatternCount * 40)
	{
		float fRate = (float)(nBodyHeight - nPatternCount * 40) / 40.0f;
		RenderBitmap(Bitmap_Message_box1, fPosX, fPosY, nWidth, 40 * fRate, 0.f, 0.f, nWidth / 256.f, (40.f / 64.f) * fRate);
		fPosY += 40 * fRate;
	}
	RenderBitmap(Bitmap_Message_box2, fPosX, fPosY, nWidth, 5, 0.f, 0.f, nWidth / 256.f, 5.f / 8.f);
