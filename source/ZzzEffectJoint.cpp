...
void MoveJoint(JOINT* o, int iIndex)
{
	...
	case BITMAP_2LINE_GHOST:
	{
		if (o->SubType == 0)
		{
			if ((o->life_time_work % standlimit(16)) <= standlimit(7))
			{
				o->m_sTargetIndex = 10;
				o->Angle[2] += timefac(o->m_sTargetIndex);
			}
			else
			{
				o->m_sTargetIndex = -10;
			...
			CreateParticleSync(BITMAP_SMOKE, o->Position, o->Angle, o->Light, 69, 1.0f);
		}
		else if (o->SubType == 1)
		{
			float TargetAngleH;
			...
			for (int j = 0; j < 8; ++j)
			{
				if (o->NumTails < o->MaxTails - 1)
				{
					...
					if (o->SubType == 0)
					{
						...
						CreateJointSync(BITMAP_JOINT_THUNDER, Light, o->Position, o->Angle, 3, NULL, rand() % 10 + 5.f, 5, 10); //  전기 
						CreateJointSync(BITMAP_JOINT_THUNDER, Light, o->Position, o->Angle, 3, NULL, rand() % 8 + 4.f, 5, 10); //  전기 
					}
				}
				if (o->SubType == 0)
				{
