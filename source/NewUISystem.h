...
namespace SEASON3B
{
	...
	private:
		...
		CNewUISecurityPanel*			m_NewUISecurity;
	...
	public:
		...
		CNewUISecurityPanel* GetUI_NewUISecurity() const;
...
#define g_pNewUISecurity		(SEASON3B::CNewUISystem::GetInstance()->GetUI_NewUISecurity())
