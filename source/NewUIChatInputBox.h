...
namespace SEASON3B
{
	...
	private:
		...
		POINT	m_WndPos;
		SIZE	m_WndSize;
		CUITextInputBox* m_pChatInputBox;
		CUITextInputBox* m_pWhsprIDInputBox;
		type_vec_history m_vecChatHistory;
		type_vec_history m_vecWhsprIDHistory;
		...
		bool m_bOnlyChatMessage;
		bool m_bOnlyPartyMessage;
		bool m_bOnlyGuildMessage;
		bool m_bOnlyGensMessage;
	...
	public:
		...
		int GetRenderWidh();
	protected:
		void GetChatText(std::string& strText);
