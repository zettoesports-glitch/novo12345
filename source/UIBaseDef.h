...
#define	CLRDW_WHITE3		ARGB(255, 200, 200, 200)
#define CLRDW_BR_GRAY		ARGB(255, 226, 226, 226)
#define CLRDW_GRAY			ARGB(255, 119, 119, 119)
#define CLRDW_YELLOW		ARGB(255, 255, 255, 121)
#define CLRDW_YELLOW2		ARGB(255, 255, 204, 25)
#define CLRDW_VIOLET		ARGB(255, 153, 102, 204)
...
#define	CLRDW_GOLD			ARGB(255, 255, 189, 25)
#define CLRDW_BLACK			ARGB(255, 0, 0, 0)
#define	CLRDW_PINK			ARGB(255, 252, 2, 169)
#define	CLRDW_CYAN			ARGB(255, 2, 184, 252)
#define	CLRDW_ALPHA			ARGB(0, 0, 0, 0)
