...
bool CGMKarutan1::RenderObjectVisual(OBJECT* o, BMD* b)
{
	...
	case 114:
		if (rand() % 3 == 0)
		{
			...
			CreateParticleSync(BITMAP_WATERFALL_3, o->Position, o->Angle, vLight, 16, o->Scale);
		}
		return true;
	case 115:
		if (o->HiddenMesh != -2)
	...
	case 116:
		if (rand() % 8 == 0)
		{
			...
			CreateParticleSync(BITMAP_SMOKE, o->Position, o->Angle, vLight, 69, o->Scale);
			CreateParticleSync(BITMAP_SMOKE, o->Position, o->Angle, o->Light, 13, o->Scale * 2.0f, o);
		}
		return true;
	case 118:
		if (o->HiddenMesh != -2)
...
bool CGMKarutan1::RenderObjectMesh(OBJECT* o, BMD* b, bool ExtraMon)
{
	...
	case MODEL_MONSTER01 + 210:
		...
		if (o->CurrentAction != MONSTER01_DIE)
		{
			...
			b->RenderMesh(0, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, 0, fLumi, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV, BITMAP_BONE_SCORPION_SKIN_EFFECT);
		}
		return true;
	case MODEL_MONSTER01 + 213:
		...
		if (o->CurrentAction != MONSTER01_DIE)
		{
			...
			b->RenderMesh(0, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, 0, fLumi, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV, BITMAP_KRYPTA_BALL_EFFECT);
		}
		return true;
	case MODEL_MONSTER01 + 214:
		...
		b->RenderMesh(3, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, 0, o->BlendMeshLight, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV);
		return true;
	case MODEL_MONSTER01 + 215:
		if (o->CurrentAction != MONSTER01_DIE)
		{
			...
			float fLumi = sinf(WorldTime * 0.002f) + 1.0f;
			b->RenderMesh(0, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, 0, fLumi, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV, BITMAP_CONDRA_SKIN_EFFECT);
			b->RenderMesh(1, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, 1, fLumi, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV, BITMAP_CONDRA_SKIN_EFFECT2);

			b->RenderMesh(3, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, 3, o->BlendMeshLight * 0.9f, WorldTime * 0.0010f, o->BlendMeshTexCoordV);
			Vector(0.4f, 0.95f, 1.0f, b->BodyLight);
			b->RenderMesh(2, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, 2, o->BlendMeshLight * 0.3f, WorldTime * 0.0015f, o->BlendMeshTexCoordV);
		}
		return true;
	case MODEL_MONSTER01 + 216:
		if (o->CurrentAction != MONSTER01_DIE)
		{
			...
			float fLumi = sinf(WorldTime * 0.002f) + 1.0f;
			b->RenderMesh(2, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, 2, fLumi, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV, BITMAP_NARCONDRA_SKIN_EFFECT);
			b->RenderMesh(3, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, 3, fLumi, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV, BITMAP_NARCONDRA_SKIN_EFFECT2);
			b->RenderMesh(1, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, 1, fLumi, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV, BITMAP_NARCONDRA_SKIN_EFFECT3);
			...
			b->RenderMesh(4, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, 4, o->BlendMeshLight * 0.9f, WorldTime * 0.0010f, o->BlendMeshTexCoordV);
			Vector(0.7f, 0.4f, 1.0f, b->BodyLight);
			b->RenderMesh(5, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, 5, o->BlendMeshLight * 0.7f, WorldTime * 0.0015f, o->BlendMeshTexCoordV);
		}
		return true;
	}
	...
	case MODEL_MONSTER01 + 215:
		if (o->CurrentAction == MONSTER01_DIE)
		{
			if (o->AnimationFrame < 1.0f)
			{
				...
				for (int j = 0; j < 6; ++j)
					CreateEffectSync(MODEL_CONDRA_STONE + rand() % 6, vPos, o->Angle, vLight, 0);
			}
			if (o->LifeTime == 100)
			{
				o->LifeTime = 90;
...
void CGMKarutan1::MoveBlurEffect(CHARACTER* pCharacter, OBJECT* pObject, BMD* pModel)
{
	...
	case MODEL_MONSTER01 + 214:
	{
		if ((pObject->AnimationFrame >= 0.f && pObject->AnimationFrame <= 6.0f && pObject->CurrentAction == MONSTER01_ATTACK1))
		{
			vec3_t  Light;
...
{
	if (gMapManager->currentMap == WD_80KARUTAN1)
		PlayMp3(g_lpszMp3[MUSIC_KARUTAN1]);
	else
		StopMp3(g_lpszMp3[MUSIC_KARUTAN1]);

	if (gMapManager->currentMap == WD_81KARUTAN2)
...
bool IsKarutanMap()
{
	return gMapManager->currentMap == WD_80KARUTAN1 || gMapManager->currentMap == WD_81KARUTAN2 ? true : false;
}
