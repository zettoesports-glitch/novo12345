...
namespace SEASON3B
{
	class CNewUIGensRanking : public CNewUIObj
	{
		...
		enum IMAGE_SIZE
		{
			GENSRANKING_WIDTH = WIN_WINDOW_SIZEX,
			GENSRANKING_HEIGHT = WIN_WINDOW_SIZEY,
			TEAMNAME_LENTH = 10,
			GENSMARK_WIDTH = 50,
			GENSMARK_HEIGHT = 69,
	...
	public:
		...
		void RanderMark2(float _x, float _y, BYTE _GensInfluence, BYTE _GensRankInfo, int _ImageArea = MARK_RANKINFOWIN, float _RenderY = 0);
