...
{
	gmClientModels->AccessModel(MODEL_XMAS_EVENT_CHA_SSANTA, "Data\\Skill\\", "xmassanta");
	gmClientModels->OpenTexture(MODEL_XMAS_EVENT_CHA_SSANTA, "Skill\\");

	gmClientModels->AccessModel(MODEL_XMAS_EVENT_CHA_SNOWMAN, "Data\\Skill\\", "xmassnowman");
	gmClientModels->OpenTexture(MODEL_XMAS_EVENT_CHA_SNOWMAN, "Skill\\");

	gmClientModels->AccessModel(MODEL_XMAS_EVENT_CHA_DEER, "Data\\Skill\\", "xmassaum");
	gmClientModels->OpenTexture(MODEL_XMAS_EVENT_CHA_DEER, "Skill\\");

	gmClientModels->AccessModel(MODEL_XMAS_EVENT_CHANGE_GIRL, "Data\\Skill\\", "santa");
	gmClientModels->OpenTexture(MODEL_XMAS_EVENT_CHANGE_GIRL, "Skill\\");

	gmClientModels->AccessModel(MODEL_XMAS_EVENT_EARRING, "Data\\Skill\\", "ring");
	gmClientModels->OpenTexture(MODEL_XMAS_EVENT_EARRING, "Skill\\");

	gmClientModels->AccessModel(MODEL_XMAS_EVENT_ICEHEART, "Data\\Skill\\", "xmaseicehart");
	gmClientModels->OpenTexture(MODEL_XMAS_EVENT_ICEHEART, "Skill\\");

	gmClientModels->AccessModel(MODEL_XMAS_EVENT_BOX, "Data\\Skill\\", "xmasebox");
	gmClientModels->OpenTexture(MODEL_XMAS_EVENT_BOX, "Skill\\");

	gmClientModels->AccessModel(MODEL_XMAS_EVENT_CANDY, "Data\\Skill\\", "xmasecandy");
	gmClientModels->OpenTexture(MODEL_XMAS_EVENT_CANDY, "Skill\\");

	gmClientModels->AccessModel(MODEL_XMAS_EVENT_TREE, "Data\\Skill\\", "xmasetree");
	gmClientModels->OpenTexture(MODEL_XMAS_EVENT_TREE, "Skill\\");

	gmClientModels->AccessModel(MODEL_XMAS_EVENT_SOCKS, "Data\\Skill\\", "xmaseyangbal");
	gmClientModels->OpenTexture(MODEL_XMAS_EVENT_SOCKS, "Skill\\");
}
...
{
	gmClientModels->AccessModel(MODEL_POTION + 51, "Data\\Item\\", "MagicBox", 2);
	gmClientModels->OpenTexture(MODEL_POTION + 51, "Item\\Texture\\");
}
...
{
	gmClientModels->AccessModel(MODEL_NEWYEARSDAY_EVENT_BEKSULKI, "Data\\Monster\\", "sulbeksulki");
	gmClientModels->OpenTexture(MODEL_NEWYEARSDAY_EVENT_BEKSULKI, "Monster\\");

	gmClientModels->AccessModel(MODEL_NEWYEARSDAY_EVENT_CANDY, "Data\\Monster\\", "sulcandy");
	gmClientModels->OpenTexture(MODEL_NEWYEARSDAY_EVENT_CANDY, "Monster\\");

	gmClientModels->AccessModel(MODEL_NEWYEARSDAY_EVENT_MONEY, "Data\\Monster\\", "sulgold");
	gmClientModels->OpenTexture(MODEL_NEWYEARSDAY_EVENT_MONEY, "Monster\\");

	gmClientModels->AccessModel(MODEL_NEWYEARSDAY_EVENT_HOTPEPPER_GREEN, "Data\\Monster\\", "sulgreengochu");
	gmClientModels->OpenTexture(MODEL_NEWYEARSDAY_EVENT_HOTPEPPER_GREEN, "Monster\\");

	gmClientModels->AccessModel(MODEL_NEWYEARSDAY_EVENT_HOTPEPPER_RED, "Data\\Monster\\", "sulredgochu");
	gmClientModels->OpenTexture(MODEL_NEWYEARSDAY_EVENT_HOTPEPPER_RED, "Monster\\");

	gmClientModels->AccessModel(MODEL_NEWYEARSDAY_EVENT_PIG, "Data\\Monster\\", "sulpeg");
	gmClientModels->OpenTexture(MODEL_NEWYEARSDAY_EVENT_PIG, "Monster\\");

	gmClientModels->AccessModel(MODEL_NEWYEARSDAY_EVENT_YUT, "Data\\Monster\\", "sulyutnulre");
	gmClientModels->OpenTexture(MODEL_NEWYEARSDAY_EVENT_YUT, "Monster\\");
}
