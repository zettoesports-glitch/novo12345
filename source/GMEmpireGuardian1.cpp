...
bool GMEmpireGuardian1::CreateRain(PARTICLE* o)
{
	...
	if (m_iWeather == (int)WEATHER_RAIN || m_iWeather == (int)WEATHER_STORM)
	{
		...
		if (rand() % 2 == 0)
		{
			...
			if (rand() % 4 == 0)
				CreateParticle(BITMAP_RAIN_02, o->Position, o->Angle, o->Light);
			else
				CreateParticle(BITMAP_RAIN_03, o->Position, o->Angle, o->Light);
		}
	}
...
void GMEmpireGuardian1::RenderFrontSideVisual()
{
	...
	case WEATHER_FOG:
	{
		...
		RenderBitmapUV(BITMAP_CHROME + 2, 0.f, 0.f, pos_right(640), pos_botton(480.0), WindX2, WindY2, 2.0f, 2.0f);
		float WindX = -(float)((int)WorldTime % 100000) * 0.00005f;
		RenderBitmapUV(BITMAP_CHROME + 2, 0.f, 0.f, pos_right(640), pos_botton(480.0), WindX, 0.f, 0.3f, 0.3f);
	}
	break;
	case WEATHER_STORM:
	{
		if (rand() % 20 == 0)
		{
			...
			RenderBitmapUV(BITMAP_CHROME + 2, 0.f, 0.f, pos_right(640), pos_botton(480.0), WindX2, WindY2, 3.0f, 2.0f);
