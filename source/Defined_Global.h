...
// CEffectRenderMesh: mesh glow/effects from av-code data (items).
// Editor UI (Y key / color editor) is disabled separately in code so players cannot change colors.
...
// SHADER_VERSION_TEST: CShaderGL (shaders auxiliares se usados)
